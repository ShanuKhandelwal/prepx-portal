...
export default function ProfessionalCourses() {
  ...
  const handlePackageConfirm = () => {
    localStorage.setItem(`packageEnrollment_professional`, JSON.stringify({
      type: "professional",
  ...
  return (
    <div className="professional-courses-wrapper">
      ...
      <div className="page-title-section">
        <h1>🎓 IT Professional Learning Path</h1>
      ...
      {selectedType === "individual" ? (
        <div className="courses-section">
          <div className="courses-header">
            ...
            <p>Pick the courses that match your needs</p>
          </div>
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="scheduling-section">
              ...
              <div className="date-options">
                <button className={`date-btn ${selectedDate === "today" ? "active" : ""}`} onClick={() => setSelectedDate("today")}>Today</button>
                <button className={`date-btn ${selectedDate === "tomorrow" ? "active" : ""}`} onClick={() => setSelectedDate("tomorrow")}>Tomorrow</button>
              </div>
            </div>
            <div className="scheduling-section">
            ...
            <div className="modal-actions">
              <button className="btn-cancel" onClick={() => setShowScheduling(false)}>Cancel</button>
              <button className="btn-confirm" onClick={handleScheduleSubmit} disabled={!selectedTime}>Confirm</button>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="enrollment-modal-wrapper">
          <div className="enrollment-modal">
            ...
            <div className="action-buttons">
              <button className="btn-change" onClick={() => { setInterviewDetails(null); setShowScheduling(true); }}>← Change Schedule</button>
              <button className="btn-proceed" onClick={() => setShowPayment(true)}>Proceed to Payment →</button>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="enrollment-modal-wrapper">
          <div className="payment-modal">
            ...
            <div className="payment-buttons">
              <button className="btn-back-payment" onClick={() => setShowPayment(false)}>← Back</button>
              <button className="btn-done" onClick={() => setShowPaymentConfirmation(true)}>Payment Done</button>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="enrollment-modal-wrapper">
          <div className="payment-confirmation-modal">
            ...
            <div className="confirmation-buttons">
              <button className="btn-cancel-confirmation" onClick={() => setShowPaymentConfirmation(false)}>← Back</button>
              <button className="btn-submit-screenshot" disabled={!paymentScreenshot}>Submit Screenshot</button>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="modal-overlay" onClick={() => setShowPackageScheduling(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="scheduling-section">
              <label>Select Date:</label>
              <div className="date-options">
                <button className={`date-btn ${packageSelectedDate === "today" ? "active" : ""}`} onClick={() => setPackageSelectedDate("today")}>Today</button>
                <button className={`date-btn ${packageSelectedDate === "tomorrow" ? "active" : ""}`} onClick={() => setPackageSelectedDate("tomorrow")}>Tomorrow</button>
              </div>
            </div>
            <div className="scheduling-section">
              <label>Select Time Slot (12 PM - 5 PM):</label>
            ...
            <div className="modal-actions">
              <button className="btn-cancel" onClick={() => setShowPackageScheduling(false)}>Cancel</button>
              <button className="btn-confirm" onClick={handlePackageScheduleSubmit} disabled={!packageSelectedTime}>Confirm</button>
            </div>
          </div>
        </div>
      )}
      ...
      {packageDetails && !showPackagePayment && (
        <div className="enrollment-modal-wrapper">
          <div className="enrollment-modal">
            ...
            <div className="action-buttons">
              <button className="btn-change" onClick={() => { setPackageDetails(null); setShowPackageScheduling(true); }}>← Change Schedule</button>
              <button className="btn-proceed" onClick={() => setShowPackagePayment(true)}>Proceed to Payment →</button>
            </div>
          </div>
        </div>
      )}
      ...
      {showPackagePayment && !showPackagePaymentConfirmation && (
        <div className="enrollment-modal-wrapper">
          <div className="payment-modal">
            ...
            <div className="payment-buttons">
              <button className="btn-back-payment" onClick={() => setShowPackagePayment(false)}>← Back</button>
              <button className="btn-done" onClick={() => setShowPackagePaymentConfirmation(true)}>Payment Done</button>
            </div>
          </div>
        </div>
      )}
      ...
      {showPackagePaymentConfirmation && (
        <div className="enrollment-modal-wrapper">
          <div className="payment-confirmation-modal">
            ...
            <div className="confirmation-buttons">
              <button className="btn-cancel-confirmation" onClick={() => setShowPackagePaymentConfirmation(false)}>← Back</button>
              <button className="btn-submit-screenshot" disabled={!packagePaymentScreenshot}>Submit Screenshot</button>
            </div>
          </div>
        </div>
      )}
