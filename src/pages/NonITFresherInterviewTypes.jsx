...
import "./NonITFresherInterviewTypes.css";

export default function NonITFresherInterviewTypes() {
  ...
  const handleNext = () => {
    if (selectedType) {
      navigate("/non-it-fresher-courses", { 
  ...
  return (
    <div className="non-it-fresher-interview-types-wrapper">
      <div className="interview-types-container">
        ...
        <div className="page-header">
          <h1>🎓 Non-IT Fresher Interview Types</h1>
