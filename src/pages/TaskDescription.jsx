...
export default function TaskDescription() {
  ...
  const tasks = {
    "resume-building": {
      ...
      price: "$29",
      keyPoints: [
        "Understand ATS (Applicant Tracking System) optimization techniques to ensure your resume gets past automated screening systems",
        "Master the structure: header, professional summary, experience, skills, and education sections with proper formatting",
        "Learn action-oriented language and quantifiable metrics to showcase achievements and impact in each role",
        "Discover industry-specific keywords and technical skills that recruiters are searching for in your target role",
        "Get professional formatting tips including fonts, spacing, and layout best practices for maximum readability"
      ],
      color: "#ff6b6b",
    },
    "technical-interview": {
      ...
      price: "$44",
      keyPoints: [
        "Practice common coding patterns and algorithms with real interview questions from top tech companies",
        "Develop problem-solving strategies: understand the problem, plan your approach, code, test, and optimize",
        "Learn communication techniques to explain your thought process clearly while solving problems on the spot",
        "Master data structures and their time/space complexity trade-offs for writing efficient solutions",
        "Build confidence through mock interviews and timed coding challenges that simulate real interview scenarios"
      ],
      color: "#4ecdc4",
    },
    "linkedin-branding": {
    ...
    "career-roadmap": {
      ...
      price: "$34",
      keyPoints: [
        "Understand different career paths in tech: backend, frontend, full-stack, data science, DevOps, and more",
        "Set SMART goals for your career development with specific milestones and timelines for achievement",
        "Learn skill progression: what to learn now, what's next, and how to build a competitive skill set progressively",
        "Discover growth opportunities: lateral moves, promotions, and ways to specialize or generalize as needed",
        "Create a personalized roadmap based on your interests, strengths, and long-term career aspirations"
      ],
      color: "#ffa502",
    },
  };

  const task = tasks[taskId] || tasks["resume-building"];

  // If user is not authenticated, show sign in/create account options
  if (!user) {
    return (
      <div style={{ minHeight: "100vh", backgroundColor: "#f8f9fa" }}>
        ...
        >
          ...
          >
            ...
            >
              <Link
                to={`/sign-in?redirect=task/${taskId}`}
                style={{
                  padding: "14px 28px",
              ...
              <Link
                to={`/create-account?redirect=task/${taskId}`}
                style={{
                  padding: "14px 28px",
                  backgroundColor: "white",
                  color: "#007bff",
