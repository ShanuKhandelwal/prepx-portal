...
export default function SystemDesignTask() {
  ...
  const task = {
    ...
    price: "$59",
    keyPoints: [
      "Learn fundamental concepts of distributed systems and scalability principles",
      "Master database design patterns: SQL vs NoSQL, sharding, replication strategies",
      "Understand caching strategies: Redis, Memcached, and optimization techniques",
      "Design real-world systems: YouTube, Twitter, Instagram, Uber-like applications",
      "Ace system design interviews with proven approaches and best practices"
    ],
    color: "#9b59b6",
  };
        ...
        <div style={{ padding: "80px 40px", textAlign: "center", display: "flex", alignItems: "center", justifyContent: "center", minHeight: "calc(100vh - 80px)" }}>
          <div style={{ maxWidth: "500px", backgroundColor: "white", borderRadius: "12px", padding: "50px 40px", boxShadow: "0 4px 16px rgba(0, 0, 0, 0.1)" }}>
            ...
            <div style={{ display: "flex", gap: "15px", flexDirection: "column" }}>
              <Link
                to={`/sign-in?redirect=task/system-design`}
              ...
              <Link
                to={`/create-account?redirect=task/system-design`}
