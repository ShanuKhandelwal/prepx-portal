  ...
  const professionalServices = [
    {
      ...
      details: "Master system design patterns, architecture decisions, and scalability concepts for senior-level interviews and roles.",
      color: "#e74c3c",
      price: "$59",
    },
    {
      ...
      description: "Master complex coding and senior-level interviews",
      details:
        "Deep dive into advanced algorithms, data structures, system design, and leadership concepts. Prepare for senior engineer and tech lead interviews with focus on technical excellence and strategic vision.",
      color: "#3498db",
      price: "$59",
    },
    {
      ...
      details:
        "Strategic career planning, negotiation techniques, and advancement opportunities for experienced professionals.",
      color: "#f39c12",
      price: "$44",
    },
    {
      ...
      details:
        "Develop leadership competencies, team management strategies, and transition into leadership roles effectively.",
      color: "#9b59b6",
      price: "$54",
    },
  ];
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#ffffff", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "40px", textAlign: "center", backgroundColor: "linear-gradient(135deg, #007bff 0%, #0056b3 100%)", backgroundImage: "linear-gradient(135deg, #007bff 0%, #0056b3 100%)", color: "white" }}>
        <h1 style={{ fontSize: "38px", fontWeight: "bold", marginBottom: "10px" }}>Professional Learning Path 💼</h1>
        <p style={{ fontSize: "16px", opacity: 0.95 }}>Advanced courses for experienced professionals</p>
      </div>
      ...
      <div style={{ padding: "40px", textAlign: "center", backgroundColor: "#f8f9fa", borderBottom: "1px solid #e9ecef" }}>
        ...
        <div style={{ display: "flex", gap: "20px", justifyContent: "center", flexWrap: "wrap" }}>
          ...
          <button
            ...
            onMouseLeave={(e) => {
              if (selectedType !== "package") e.currentTarget.style.backgroundColor = "white";
            }}
          >
            🎁 Complete Package
          </button>
          ...
          {selectedType === "individual" && (
            <div>
              ...
              <p style={{ fontSize: "14px", color: "#666", marginBottom: "40px", textAlign: "center" }}>
                5 advanced courses for professional growth
              </p>
            ...
            <div>
              ...
              <div style={{ maxWidth: "900px", margin: "0 auto 50px", backgroundColor: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)", backgroundImage: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)", borderRadius: "16px", padding: "50px 40px", color: "white", boxShadow: "0 10px 40px rgba(102, 126, 234, 0.4)", textAlign: "center" }}>
                ...
                <div style={{ backgroundColor: "rgba(0, 0, 0, 0.2)", borderRadius: "12px", padding: "25px", marginBottom: "30px" }}>
                  ...
                  <p style={{ fontSize: "16px", fontWeight: "bold", color: "#4ade80" }}>Save ${savings} (42% OFF)</p>
                </div>
