...
export default function TechLeadershipTask() {
  ...
  const task = {
    ...
    description: "Lead technical teams with confidence",
    price: "$49",
    keyPoints: [
      "Develop essential leadership skills: communication, delegation, and decision-making",
      "Learn to manage technical teams effectively while maintaining technical credibility",
      "Master conflict resolution and difficult conversations in a technical environment",
      "Build a culture of innovation, collaboration, and continuous improvement",
      "Understand business acumen and how to align technical strategy with business goals"
    ],
    color: "#16a085",
  };
        ...
        <div style={{ padding: "80px 40px", textAlign: "center", display: "flex", alignItems: "center", justifyContent: "center", minHeight: "calc(100vh - 80px)" }}>
          <div style={{ maxWidth: "500px", backgroundColor: "white", borderRadius: "12px", padding: "50px 40px", boxShadow: "0 4px 16px rgba(0, 0, 0, 0.1)" }}>
            ...
            <div style={{ display: "flex", gap: "15px", flexDirection: "column" }}>
              <Link
                to={`/sign-in?redirect=task/tech-leadership`}
              ...
              <Link
                to={`/create-account?redirect=task/tech-leadership`}
