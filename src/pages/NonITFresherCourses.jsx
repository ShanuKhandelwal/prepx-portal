...
import "./NonITFresherCourses.css";
...
export default function NonITFresherCourses() {
  ...
  const handlePackageConfirm = () => {
    localStorage.setItem(`packageEnrollment_non-it-fresher`, JSON.stringify({
      type: "fresher",
  ...
  return (
    <div className="non-it-fresher-courses-wrapper">
      ...
      <div className="page-title-section">
        <h1>🎓 Non-IT Fresher Learning Path</h1>
