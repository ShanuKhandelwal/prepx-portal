...
export default function JobSearchTask() {
  ...
  const task = {
    ...
    price: "$29",
    keyPoints: [
      "Learn effective job search strategies tailored for freshers, where to find opportunities, and how to apply strategically",
      "Master networking tips: how to reach out to professionals, build meaningful connections, and leverage your network",
      "Discover hidden job markets and direct referral opportunities that aren't posted on job boards",
      "Develop a personal brand and online presence that attracts recruiters and hiring managers to you",
      "Learn interview follow-up strategies and techniques to stand out among other candidates"
    ],
    color: "#9b59b6",
  };
        ...
        <div style={{ padding: "80px 40px", textAlign: "center", display: "flex", alignItems: "center", justifyContent: "center", minHeight: "calc(100vh - 80px)" }}>
          <div style={{ maxWidth: "500px", backgroundColor: "white", borderRadius: "12px", padding: "50px 40px", boxShadow: "0 4px 16px rgba(0, 0, 0, 0.1)" }}>
            ...
            <div style={{ display: "flex", gap: "15px", flexDirection: "column" }}>
              <Link
                to={`/sign-in?redirect=task/job-search`}
              ...
              <Link
                to={`/create-account?redirect=task/job-search`}
